        ...
        <main class="main-content">
            <div class="container">
                <div class="left-section">
                    ...
                    <div class="options">
                        <a href="{{ route('individual-register') }}" class="option">
                            <h2>Individual</h2>
                        </a>
                        <a href="{{ route('business-register') }}" class="option">
                            <h2>Business</h2>
                        </a>
                    </div>
                    <h4>Please Select</h4>
                    <a href="{{ route('register-client-or-attorney') }}" class="back-btn">Back</a>
                </div>
