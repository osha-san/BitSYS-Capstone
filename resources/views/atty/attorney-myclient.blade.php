...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/attorney/attorney-myclient.css') }}">
    <script src="{{ asset('js/attorney/attorney-myclient.js') }}" defer></script>
            ...
            <div class="client-list">
                @foreach($clients as $client)
                    <div class="client-item">
                        ...
                        <a href="{{ route('attorney.clients.show', $client->id) }}">View Details</a>
                    </div>
                @endforeach
            </div>
        </div>
