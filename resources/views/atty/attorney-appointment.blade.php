...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/attorney/attorney-appointment.css') }}">
    <script src="{{ asset('js/attorney/attorney-appointment.js') }}" defer></script>
