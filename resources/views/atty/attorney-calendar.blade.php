...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/attorney/attorney-calendar.css') }}">
    <script src="{{ asset('js/attorney/attorney-calendar.js') }}" defer></script>
    ...
    <section class="sidebar">
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><a href="{{ route('admin.calendar') }}" class="active"><img src="{{ asset('img/icons/admin/calendar.png') }}" alt="calendar">Calendar</a></li>
