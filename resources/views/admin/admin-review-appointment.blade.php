...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/admin-review-appointments.css') }}">
    <script src="{{ asset('js/admin/admin-review-appointments.js') }}" defer></script>
    ...
    <section class="sidebar">
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><a href="{{ route('admin.reviewAppointments') }}" class="active"><img src="{{ asset('img/icons/admin/review.png') }}" alt="review appointments">Review Appointments</a></li>
            </ul>
        </nav>
    </section>
