...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/admin-logbook.css') }}">
    <script src="{{ asset('js/admin/admin-logbook.js') }}" defer></script>
    ...
    <section class="sidebar">
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><a href="{{ route('admin.logbook') }}" class="active"><img src="{{ asset('img/icons/admin/logbook.png') }}" alt="logbook">Logbook</a></li>
            ...
            <div class="logbook-list">
                @foreach($logbookEntries as $entry)
                    <div class="logbook-item">
                        ...
                        <a href="{{ route('admin.logbook.show', $entry->id) }}">View Details</a>
                    </div>
                @endforeach
            </div>
        </div>
