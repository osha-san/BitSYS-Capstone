...
document.getElementById("toAppointment").onclick = function() {
    window.location.href = "attorney-appointment.html";
};

document.getElementById("toMyclients").onclick = function() {
